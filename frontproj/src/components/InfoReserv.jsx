...
function InfoReserv({ data, horario, valor, bola, rede, coletes }) {
  return (
    <div className="flex flex-row w-5/6 h-1/4 space-x-3">
      <div className="flex flex-col w-2/3 bg-yellow-200 space-y-2 text-violet-900 mr-5">
        <h3 className="ml-2 mt-2">Data: {data}</h3>
        <h3 className="ml-2">Horário: {horario}</h3>
        <h3 className="ml-2">Valor: {valor},00 R$</h3>
      </div>
      <div className="flex flex-col bg-yellow-200 w-2/3 space-x-2 text-violet-900">
